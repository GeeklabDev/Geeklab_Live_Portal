        ...
        <form action="/student/posts/add" method="POST" class="form-group" enctype="multipart/form-data">
            ...
            <div class="post-group">
                <div class="form-group mt-3 make-post">
                    <textarea name="content" id="" placeholder="Ինչ՞ կա մտքիդ {{ Auth::user()['name'] }} ջան" class="md-textarea form-control"></textarea>
                 ...
                 f                                   {{ $post->content }}
                                    ...
                                    <i class="fa fa-thumbs-up fa-stack-1x fa-inverse"></i>
                                            ...
                                            <div class="timeline-footer">
                                                ...
                                                @else
                                                    <a href="/like/dislike/{{ $post->id }}#post-{{ $post->id }}" class="m-lg-2 text-inverse-lighter"><i class="fa fa-thumbs-up fa-fw fa-lg m-r-3"></i> Dislike</a>
                                                @endif
